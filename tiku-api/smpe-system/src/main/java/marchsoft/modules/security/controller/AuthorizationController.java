...
import marchsoft.modules.security.service.StudentUserDetailServiceImpl;
import marchsoft.modules.security.service.UserDetailsServiceImpl;
...
public class AuthorizationController {
    ...
    private final StudentUserDetailServiceImpl studentUserDetailService;
    private final DaoAuthenticationProvider daoAuthenticationProvider;

    private final ProviderManager providerManager;

    private final UserDetailsServiceImpl userDetailsService;
    @ApiOperation("前台：登录授权")
    @AnonymousPostMapping(value = "/reception/login")
    public Result<Map<String, Object>> frontLogin(@Validated @RequestBody AuthUserDto authUser,
        ...
        Long studentId = studentService.findStudentIdByStudentNumAndDeptId(authUser.getUsername(), authUser.getDeptId());

        daoAuthenticationProvider.setUserDetailsService(studentUserDetailService);
        ...
        // 保存在线信息
        onlineUserService.studentSave(jwtUserDto, token, request);
        // 返回 token 与 用户信息
