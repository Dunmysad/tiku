...
public class MybatisPlusGenerator {
    ...
    /** 数据库连接URL */
    private final static String URL = "jdbc:log4jdbc:mysql://101.34.164.77:3307/tiku?" +
    ...
    private static StrategyConfig setStrategyConfig() {
        ...
        strategy
                ...
                //设置写入实体父类的字段
//                .LambdaQueryWrapper<ELearningMaterials> queryWrapper = new LambdaQueryWrapper<>();
//        queryWrapper.eq(ELearningMaterials::get)setSuperEntityColumns("create_time", "update_time", "create_by", "update_by", "is_deleted")
